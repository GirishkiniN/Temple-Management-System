...
<div class="topnav">
  ...
  <a class="active" href="donation.php">DONATION</a>
 <div class="dropdown">
...
<form name="frm" action="" method="POST">	
     <table><br>
         <tr>			
               <td>				
                    <font color="red">DONOR_ID:</font> 				
               </td>			
                <td>				
                    <p><input type=”integer” name="ddid"  placeholder="Enter donor_id"></p>			
                </td>		
           </tr>
           <tr>
                 <td>				
                    <font color="red">DONOR_NAME:</font>  				
                 </td>			
                 <td>				
                     <p><input type=”text” name="ddname"  placeholder="Enter donor_name"></p>			
                 </td>
         ...
         <tr>
                 ...
                 <td>				
                     <p><input type="text" name="dadd"  placeholder="Enter address"></p>			
                 </td>		
           </tr>
           <tr>
                 <td>				
                 <font color="red">PHONE_NO:</font>  			
                 </td>			
                 <td>				
                     <p><input type=”text” name="dpho"  placeholder="Enter phone_no"></p>		
                 </td>		
           </tr>
          <tr>
                 <td>				
                 ...
                 <td>				
                     <p><input type=”integer” name="damt"  placeholder="Enter amount"></p>			
                 </td>		
           </tr>
         <tr>
                 <td>				
                    <font color="red">PAYMENT_MODE:</font>  				
                 </td>			
                 <td>				
                     <p><input type=”text” name="dpm"  placeholder="Enter payment_mode"></p>			
                 </td>		
           </tr>	
         <tr>
                 <td>				
                 ...
                 <td>				
                     <p><input type=”text” name="dtname"  placeholder="Enter temple_name"></p>			
                 </td>		
           </tr>	
     </table>
...
{
  $pddid=$_POST['ddid'];
  $pddname=mysqli_real_escape_string($conn,$_POST['ddname']);
  $pdadd=$_POST['dadd'];
  $pdpho=$_POST['dpho']; 	
  $pdamt=$_POST['damt'];	
  $pdpm=$_POST['dpm'];	
  $pdtname=$_POST['dtname'];	
  $querystring="INSERT INTO donation(did,dname,address,dphone,damount,paymentmode,templename) VALUES('$pddid','$pddname','$pdadd','$pdpho','$pdamt','$pdpm','$pdtname')";	
...
if(isset($_POST['sub2']))
{
  ...
  $pdpm=$_POST['dpm'];	
  $pdtname=$_POST['dtname'];	
  $sql="DELETE FROM donation WHERE did='$pddid'"; 
