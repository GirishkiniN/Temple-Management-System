...
<div class="topnav">
 ...
 <a  href="contactus.php">CONTACT US</a>
  ...
  <head>
     <h1><font color="red">SEVAS AVAILABLE</font> </h1>
  </head>  
<body>
    <body background="back8.jpg">
<form name="frm" action="" method="POST">	
     <table><br>
         
           <tr>
                 <td>				
                    <font color="black">SEVANAME:</font>  				
                 </td>			
                 <td>				
                  <p><input type=”text” name="sname" placeholder="Enter seva_name"></p>			
                 </td>
		</tr>		 
             <tr>
                 <td>				
                 ...
                 <td>				
                 <p><input type=”integer” name="rate" placeholder="Enter rate"></p> 
         </tr>
           <tr>
                 <td>				
                 ...
                 <td>				
                     <p><input type=”text” name="tname" placeholder="Enter temple_name"></p>			
                 </td>		
           </tr>	
     </table>
...
if(isset($_POST['sub3']))
{
  $psname=mysqli_real_escape_string($conn,$_POST['sname']);
  $prate=$_POST['rate'];
  $ptname=$_POST['tname'];	
  $querystring="INSERT INTO sevasavailable(sevaname,rate,templename) VALUES('$psname','$prate','$ptname')";	
...
if(isset($_POST['sub2']))
{
  ...
  $prate=$_POST['rate'];
  $ptname=$_POST['tname'];	
  $sql="DELETE FROM sevasavailable WHERE sevaname='$psname'"; 
