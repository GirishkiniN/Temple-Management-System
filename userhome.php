...
<body bgcolor="#FBFBFD">
    ...
    <a href="userseva.php">seva</a>
    
  <a class="active" href="userhome.php">Home</a>
</div>
    <center><h2><font color="red">TEMPLE MANAGEMENT</font></h2></center>
<div class="bg-img">
...
<div class="w3-content w3-section" style="max-width:500px">
  <center><img class="mySlides" src="images/back11.jpg" style="width:100%">
  <img class="mySlides" src="images/back3.jpg" style="width:100%">
  <img class="mySlides" src="images/back4.jpg" style="width:100%">
    </center></div>

    
    <p><center><font colour="red">THANKS FOR VISITING OUR WEBSITE</font></center>
<script>
var myIndex = 0;
carousel();
