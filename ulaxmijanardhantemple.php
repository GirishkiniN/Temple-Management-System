...
<div class="dropdown">
    ...
    <div class="dropdown-content">
	  ...
	  <a class="active" href="ulaxmijanardhantemple.php">laxmi janardhana temple</a>
	</div>
  </div>
...
<div style="padding-left:16px">
 <center><h2><font color="white">LAXMI JANARDHAN TEMPLE,KAUP</font></h2></center>
 <div class="bg-img">
 </div>
 <div>
...
<br><br><p><h2><center>LIST OF SEVAS OF LAXMI JANARDHAN TEMPLE</center></h2></p>
...
<form name="frm" action="" method="POST">
  ...
  <option value="">....select temple name....</option>
   <option value="laxmi janardhana temple">laxmijanardhanatemple</option>
</select></p>			
                 </td>		
           </tr>	
     </table></center>
