...
<html>
<head>
<title>Hale mariyamma temple</title>
<style>
table, th, td {
...
<style>
    .bg-img {
  /* The image used */
  background-image: url("images/halemariyammatemple.jpeg");
 ...
 <div class="dropdown">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a class="active" href="halemariyammatemple.php">hale mariyamma temple</a>
...
<div style="padding-left:16px">
 <center><h2><font color="white">HALE MARIYAMMA TEMPLE,KAPU</font></h2></center>
 <div class="bg-img">
 </div>
 <div>
 <br><br><p><h2><center>ABOUT TEMPLE</center></h2></p>
<p>Since ancient times Kaup is known as "Hoovina Hitthilu". Sri Mariyamma Devi, who is the owner of said place, has been blessing the devotees who come there.
...
It is common in various of Udupi, Dakshina Kannada Districts, where there are Tulu speaking people, Pancha Daivasthanas, lots of Daivas (Ghosts) have settled and get worshipped everyw here. It is worth noting that the idea of Maari & Anusandhana are in custom socially only.</p></div>

<br><br>-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------


<br><br><p><h2><center>LIST OF SEVAS OF HALE MARIYAMMA TEMPLE</center></h2></p>
...
<form name="frm" action="" method="POST">
  ...
  <option value="halemariyammatemple">halemariyammatemple</option>
</select></p>			
                 </td>		
           </tr>	
     </table></center>
