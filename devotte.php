...
<div class="topnav">
  ...
  <a class="active" href="devotte.php">DEVOTEE</a>
 ...
 <div class="dropdown">
  ...
  <a href="logout.php">LOGOUT</a>
      ...
      <h1> <center>DEVOTEE DETAILS</center></h1>
  </head>  
<body>
...
<form name="frm" action="" method="POST">	
     <table><br>
         <tr>			
               <td>				
                   <font color="yellow">D_ID:</font> 				
               </td>			
                <td>				
                    <p><input type=”integer” name="ddid" placeholder="Enter d_id"></p>			
                </td>		
           </tr>
           <tr>
                 <td>				
                 ...
                 <td>				
                    <p><input type=”text” name="dname"  placeholder="Enter name"></p>			
                 </td>
          ...
          <tr>
              <td>
                 ...
                 <td>				
                     <p><input type=”integer” name="dphno"  placeholder="Enter phone_no"></p>		
                 </td>		
           </tr>
         <tr>
                 <td>				
          ...
          <tr>
                 <td>				
                    <font color="yellow">EMAIL_ID:</font>  				
                 </td>			
                 <td>				
                     <p><input type=”text” name="deid"  placeholder="Enter email_id"></p>			
                 </td>		
           </tr>
...
{
  $pddid=$_POST['ddid'];
  $pdname=mysqli_real_escape_string($conn,$_POST['dname']);
  $pdphno=$_POST['dphno'];
  $pdadd=$_POST['dadd'];
  $pdeid=$_POST['deid'];
  $pdtname=$_POST['dtname'];
  $querystring="INSERT INTO devotte(did,name,phoneno,address,emailid,templename) VALUES('$pddid','$pdname','$pdphno','$pdadd','$pdeid','$pdtname')";	
   ...
   if(isset($_POST['sub2']))
{
  ...
  $pdeid=$_POST['deid'];
  $pdtname=$_POST['dtname'];
  $sql="DELETE FROM devotte WHERE did='$pddid'"; 
